...
## Pendiente
- [ ] La página sync no debe ser parte del loop, solo debe aparecer al inicio de cada sesión
- [ ] Antes de ir a la página de la la encuesta Psychological Flow Scale, debe mostrarse una página que pregunte si desea reportar su experiencia en la sesión para mejoras en la próxima. Un botón de omitir y otro de responder. Omitir te lleva a la página de inicio, responder a la página de la encuesta.
