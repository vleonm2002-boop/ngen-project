...
- [ ] Página 2 (Settings): selector de ciclo con opciones 25min/5min, 40min/10min, 50min/10min
- [ ] Página 2 (Settings): calcular y mostrar cantidad_ciclos = floor(duración_total / (flow + break)) y guardar en variable de estado local
- [ ] Página 2 (Settings): reporte de bienestar inicial — 4 sliders Likert 1–7 para estrés, ansiedad, tristeza y cansancio. Guardar como Stress_start_Score, Anxiety_start_Score, Saddness_start_Score, Tiredness_start_Score
- [ ] Página 3 (Flow State): cronómetro regresivo con duración de flow seleccionada
